...
dd if=kernel.bin of=img/kernel.img bs=512 count=20

dd if=img/loader.img of=img/boot.img skip=0 seek=1 bs=512 count=1
dd if=img/kernel.img of=img/boot.img skip=0 seek=2 bs=512 count=22

dd if=img/floppy.img of=img/boot.img skip=14 seek=14 bs=512 count=2858
